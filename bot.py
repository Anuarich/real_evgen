...
async def handle(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    # Отвечаем клиенту с кнопкой-ссылкой на риэлтора
    keyboard = [[InlineKeyboardButton('💬 Написать риэлтору', url=REALTOR_LINK)]]

    await update.message.reply_text(
        f'Привет, {user.first_name}! 👋\n\n'
        f'Нажми кнопку ниже — сообщение риэлтору уже заготовлено, '
        f'просто отправь его.',
